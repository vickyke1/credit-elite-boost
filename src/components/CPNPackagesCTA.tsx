      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <ScrollReveal
            variant="scale-in"
            delay={150}
            className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border/50"
          >
          ...
          {/* CTA Button */}
          <ScrollReveal variant="scale-in" delay={350}>
